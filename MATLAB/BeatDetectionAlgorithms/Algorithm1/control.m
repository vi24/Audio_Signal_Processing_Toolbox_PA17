...
%        MAXFREQ = 4096
  ...
  if nargin < 2, bandlimits = [0 200 400 800 1600 3200 6400 12800]; end
  %if nargin < 2, bandlimits = [0 2 4 8 16 32 64 128 256 512 1024 2048 4096 8192 16384]; end

  if nargin < 3, maxfreq = 20000; end
  if nargin < 1, song1 = 'C:\Users\Matthias\Google Drive\zhaw\Semester5\PA\audio\tamborine_120bpm_1-4time_121beats_stereo.mp3'; end 
