...
if nargin < 1, songFile = 'C:\Users\Matthias\StudioProjects\Audio_Signal_Processing_Toolbox\documents\audioFiles\TeddybearsSthlm_HeyBoy_trimmedToOneMinute.mp3'; end

[audioAsArray, fs] = audioread(songFile);
%audioAsArray = audioAsArray(1:480471);
%audioAsArray = audioAsArray';
