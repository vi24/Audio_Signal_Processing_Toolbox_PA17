...
public class PCMUtil {
    ...
    /**
     * Converts an array of shorts into an array of doubles and normalizes the values
     * @param samples array of shorts to be converted
     * @return normalized, double array containing the converted values
     */
    public static double[] short2DoubleArray(short[] samples) {
        Log.d(TAG,"short2DoubleArray got called");
