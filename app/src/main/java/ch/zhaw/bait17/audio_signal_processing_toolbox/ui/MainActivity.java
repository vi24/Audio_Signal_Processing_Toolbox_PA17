...
public class MainActivity extends AppCompatActivity implements
        ...
        FileSelectionFragment.OnFileSelectedListener,
        MetronomFragment.OnSelectFileListener{
    ...
    private static final String TAG_METRONOM_FRAGMENT = "METRONOM";
    private static final String TAG_FILESELECT_FRAGMENT = "FILESELECT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File metronome = new File(Environment.getExternalStorageDirectory()+File.separator+"audio_signal_processing_metronome");
        if(!metronome.exists()){
            metronome.mkdirs();
        }
    ...
    private void initFragments() {
        ...
        ft.replace(R.id.content_frame, new MetronomFragment(), TAG_METRONOM_FRAGMENT);
        ft.replace(R.id.content_frame, new FileSelectionFragment(), TAG_FILESELECT_FRAGMENT);
    ...
    private boolean selectMenuItem(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_about:
                ...
                break;
            case R.id.nav_metronom:
                Log.i("Info", "You pressed the Metronom menu entry. Congratulations");
                fragment = getFragmentByTag(TAG_METRONOM_FRAGMENT);
                //TODO implement the new fragment
                title = getString(R.string.drawer_menu_item_metronom);
                tagFragmentName = TAG_METRONOM_FRAGMENT;
            default:
                break;
        }

        if (fragment != null && !fragment.isVisible()) {
            Log.i("Info", "Going ot replace fragment " + fragment.getTag());
...
// Commit the transaction
    ...
    public void onFileSelected(String uri) {
        ...
        MetronomFragment fragment = new MetronomFragment();
