...
JNIEXPORT void JNICALL Java_ch_zhaw_bait17_audio_1signal_1processing_1toolbox_androidlame_AndroidLame_initializeDefault(
        JNIEnv *env, jclass cls) {

    glf = initializeDefault(env);
}

JNIEXPORT void JNICALL Java_ch_zhaw_bait17_audio_1signal_1processing_1toolbox_androidlame_AndroidLame_initialize(
...
JNIEXPORT jint JNICALL Java_ch_zhaw_bait17_audio_1signal_1processing_1toolbox_androidlame_AndroidLame_lameEncode(
...
JNIEXPORT jint JNICALL Java_ch_zhaw_bait17_audio_1signal_1processing_1toolbox_androidlame_AndroidLame_encodeBufferInterleaved(
        JNIEnv *env, jclass cls, jshortArray pcm,
        jint samples, jbyteArray mp3buf) {
    return encodeBufferInterleaved(env, glf, pcm, samples, mp3buf);
}

JNIEXPORT jint JNICALL Java_ch_zhaw_bait17_audio_1signal_1processing_1toolbox_androidlame_AndroidLame_lameFlush(
        JNIEnv *env, jclass cls, jbyteArray mp3buf) {
    return flush(env, glf, mp3buf);
}

JNIEXPORT void JNICALL Java_ch_zhaw_bait17_audio_1signal_1processing_1toolbox_androidlame_AndroidLame_lameClose(
        JNIEnv *env, jclass cls) {
    close(glf);
}
